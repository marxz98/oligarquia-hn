...
function rEDet(c, id) {
  ...
  c.innerHTML = `<div class="pbk" onclick="nav('empresas')">← Empresas</div>
    <div class="phero"><button class="ed-btn" style="right:90px" onclick="event.stopPropagation();showModal('addVinculo',{tipo:'empresa',id:${e.id}})">+ VINCULO</button><button class="ed-btn" onclick="showModal('editEmpresa',${e.id})">✏ EDITAR</button>
